...
export default function Project({ title, period, videoLink, techUsed = [], description, gitLink })
{
    return <div className="text-communicator-white pl-4 font-SpaceMono">

            <li className="list-disc font-bold text-5xl text-communicator-red" >
                {title}
            </li>
            <div className="border-communicator-red border-l-[6px] ml-[10px] pl-9 ">
                <h2 className="text-3xl" >{period}</h2>
                ...
                <div className="text-3xl">{description.map((value, index) => {
                ...
                { gitLink != null ? <div className ='button w-36 h-10 my-5 bg-green-400 rounded-full cursor-pointer select-none
		                                    ...
		                                    <a href = { gitLink } target = "_blank" className ='flex flex-col justify-center items-center h-full text-white font-bold text-4xl '>Github</a>
