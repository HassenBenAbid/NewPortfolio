    ...
    return <Html className   = " w-[1095px] h-[1570px] bg-[#DFDFDE] select-none" 
        ...
        <div>
            { isFocused ?
                <div> 
                    ...
                    <div className="flex flex-row h-[80px]" >
                        ...
                        <div className="flex bg-[#FE0000] text-[#DFDFDE] w-[325px] cursor-pointer font-SpaceMono font-bold items-center justify-center text-[45px] border-b-[15px] border-b-[#DFDFDE]
                            hover:border-b-[0px]
                            translation-all duration-150" onClick = {  () => { playPublicityDisplaySound(); onCloseCallback(); } }>Back</div>
                    </div>
                    
                    <div className = "mx-2 mt-6 font-bold text-[#112A46] text-[40px] font-SpaceMono border-l-[10px] border-[#112A46]" > 
                        <div className=" ml-2" >
                            Hello there! <br /> <br /> 
                    ...
                    <a className="text-[75px] text-[#112A46] font-bold font-SpaceMono mt-14 mb-1 flex flex-col justify-center items-center border-x-[150px] border-[#112A46]
            ...
            : <div>
                ...
                <div className = "flex justify-center text-[105px] font-SpaceMono font-bold text-[#112A46] " >
                    HASSEN'S CANTINA
                </div>

                <div className = "flex justify-center font-SpaceMono font-bold text-[50px] mb-[70px] text-[#112A46]">
